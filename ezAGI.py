...
def main():
    ...
    with ui.tabs().classes('w-full') as tabs:
        ...
        admin_tab = ui.tab('ADMIN').classes('tab-style')
    ...
    with ui.tab_panels(tabs, value=chat_tab).props('style="background-color: rgba(255, 255, 255, 0.5);"').classes('response-style'):
        ...
        # create admin tab panel for Ollama buttons
        with ui.tab_panel(admin_tab):
            ui.link('Go to Ollama Page', '/ollama')
    ...
    # Initialize the FAB and add actions for the models
